...
export default function ReviewPage() {
  ...
  if (isSubmitted) {
    return (
      <div
        ...
        style={{
          background:
            "linear-gradient(160deg, #ffffff 0%, #FDECEF 35%, #f3e8f7 65%, #ffffff 100%)",
        }}
      >
        <Card className="w-full max-w-md overflow-hidden rounded-3xl border-0 bg-white shadow-2xl">
          <CardContent className="p-8 text-center">
            ...
            <h2 className="mb-4 font-serif text-2xl font-bold text-foreground">Thank You!</h2>
  ...
  return (
    ...
    >
      {/* Nav */}
      <header className="border-b border-[#F9DDE5] bg-white/80 px-6 py-4 backdrop-blur-sm">
      ...
      <main className="px-4 py-8 md:py-16">
        <div className="mx-auto max-w-lg">
          ...
          <div className="mb-8 text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 shadow-sm border border-[#F9DDE5]">
          ...
          <Card className="overflow-hidden rounded-3xl border-0 bg-white shadow-2xl">
            <CardHeader
              ...
              style={{
                background:
                  "linear-gradient(135deg, #FDECEF 0%, #f3e8f7 100%)",
              }}
            >
